...
from tlmshop.models import Product, Commodity, SmartCard, SmartPhone, SmartPhoneModel
from tlmshop.models.i18n_polymorphic.smartphone import OperatingSystem
...
class SmartPhoneAdmin(SortableAdminMixin, TranslatableAdmin, FrontendEditableAdminMixin,
    ...
    def render_text_index(self, instance):
        template = get_template('search/indexes/tlmshop/commodity_text.txt')
