# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-03-27 14:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('master', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='translations', to='tlmshop.Commodity')),
            ],
        ),
        migrations.CreateModel(
            name='Customer',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='tlmshop.Commodity', verbose_name='Product')),
            ],
        ),
        migrations.CreateModel(
            name='OrderPayment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tlmshop.Commodity')),
            ],
            options={
                'ordering': ('order',),
                'abstract': False,
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='polymorphic_tlmshop.commodity_set+', to='contenttypes.ContentType'),
        ),
        migrations.AddField(
            model_name='commodity',
            name='sample_image',
        ...
        migrations.AddField(
            model_name='cartitem',
            name='product',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tlmshop.Commodity'),
        ),
        migrations.AddField(
            model_name='cart',
            name='customer',
