    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cms_pages', models.ManyToManyField(help_text='Choose list view this product shall appear on.', through='tlmshop.ProductPage', to='cms.Page')),
                ('images', models.ManyToManyField(through='tlmshop.ProductImage', to='filer.Image')),
                ('manufacturer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tlmshop.Manufacturer', verbose_name='Manufacturer')),
                ('polymorphic_ctype', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='polymorphic_tlmshop.smartcard_set+', to='contenttypes.ContentType')),
            ],
            options={
                'ordering': ('order',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('master', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='translations', to='tlmshop.SmartCard')),
            ],
        ),
        migrations.AddField(
            model_name='productpage',
            name='product',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tlmshop.SmartCard'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='product',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='tlmshop.SmartCard', verbose_name='Product'),
        ),
        migrations.AddField(
            model_name='cartitem',
            name='product',
